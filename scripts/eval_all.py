...
# dead_zone·content_gap만 --category를 받는다 (다른 차원은 카테고리 무관).
_DIMS_WITH_CATEGORY: frozenset[Dimension] = frozenset({"dead_zone", "content_gap"})
